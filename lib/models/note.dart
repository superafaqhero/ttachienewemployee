class Note {
  ...
  Note(this._title, this._date,this.position, this._totalprice,this._deposit,this._balance,this._collectthisweek, this._priority,[this._description, this._email, this._number, this._address]);

  Note.withId(this._id, this._title, this._date, this.position, this._totalprice,this._deposit,this._balance,this._collectthisweek, this._priority,[this._description, this._email, this._number, this._address]);
