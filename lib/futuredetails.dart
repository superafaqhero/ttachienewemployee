...
class Futuredetails extends StatefulWidget {
  ...
  Futuredetails(this.note, this.appBarTitle);
...
class NoteDetailState extends State<Futuredetails> {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Add Future Projects"),
  ...
  void moveToLastScreen() {
    // Navigator.pop(context, true);
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Salesproject()));
  }
  ...
  void _save() async {
    ...
    if (note.id != null) {  // Case 1: Update operation
      result = await helper.updateFuture(note);
    } else { // Case 2: Insert Operation
      result = await helper.insertFuture(note);
    }
  ...
  void _delete() async {
    ...
    int result = await helper.deleteFuture(note.id!);
    if (result != 0) {
